...
- Create Angular project with ng: `ng new angularaspnetcoredashboarddemo.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`angularaspnetcoredashboarddemo.client.esproj`).
